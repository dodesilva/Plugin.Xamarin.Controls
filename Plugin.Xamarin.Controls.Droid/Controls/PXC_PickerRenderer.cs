...
namespace Plugin.Xamarin.Controls.Droid.Controls
{
    ...
    {
        Context _context;
        public PXC_PickerRenderer(Context context) : base(context)
        {
            _context = context;
        }
        ...
        private Drawable BorderBackGround(PXC_Picker view)
        {
        ...
        public LayerDrawable AddPickerStyles(PXC_Picker view)
        {
