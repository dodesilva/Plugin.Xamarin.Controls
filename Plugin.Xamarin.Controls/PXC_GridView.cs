...
{
    public class PXC_GridView : ListView, IScrollAwareElement
    {
        #region Fields
        ...
        /// </summary>
        public static readonly BindableProperty IsHeightRequestWithValueProperty = BindableProperty.Create(nameof(IsHeightRequestWithValue), typeof(bool), typeof(PXC_GridView), 1D);

        public bool IsHeightRequestWithValue
        {
            get { return (bool)GetValue(IsHeightRequestWithValueProperty); }
            set
            {
                SetValue(IsHeightRequestWithValueProperty, value);
            }
        }
